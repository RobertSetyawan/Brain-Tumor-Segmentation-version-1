...
%
%   J = IMBINARIZE(V, ___) binarizes volume V using Otsu's threshold if no
%   other argument is given. 3D binary conversion is supported for both global
%   and adaptive thresholding and follows the same argument rules as for a 
%   grayscale image. J is the output binary volume.
%
%   Class Support
%   -------------
%   The input image I can be a real, non-sparse, 2-D matrix 
%   and input volume V can be real, non-sparse 3-D array of one of the
%   following classes: uint8, int8, uint16, int16, uint32, int32, single or
%   double. The output binary image BW or J is a logical matrix of the same size
%   as I or V respectively.
%
%   Notes
%   -----
...
%   Example 4
%   ---------
%   This example shows binarization for a 3D input volume using global thresholding.
%
%   load mristack;
%   V = mristack;
%   figure
